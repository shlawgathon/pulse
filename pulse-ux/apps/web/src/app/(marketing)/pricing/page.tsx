    ...
    <div className="relative min-h-screen pt-24 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 font-sans">Simple, transparent pricing</h1>
          <p className="text-xl text-white/70">Start optimizing your UX today. Scale as you grow.</p>
        </div>
