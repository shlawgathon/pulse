      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>The domain where the actuator script will be installed</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          <div className="pt-4 border-t border-border">
            <h2 className="text-sm font-medium text-foreground mb-4">GitHub Integration (Optional)</h2>
            <p className="text-xs text-muted-foreground mb-4">
              Connect a GitHub repository to automatically generate Pull Requests for winning variants.
            </p>
          ...
          <ErrorAlert error={createSite.error} fallbackMessage="Failed to create site" />

          <div className="flex gap-3 pt-4">
            <Button type="button" variant="outline" onClick={() => router.back()} className="flex-1">
              Cancel
            </Button>
            <Button type="submit" disabled={createSite.isPending} className="flex-1">
