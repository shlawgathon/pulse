  ...
  return (
    <button
      ...
      className={cx(
        ...
        disabled
          ? "cursor-not-allowed text-copy-lighter"
          : "cursor-pointer text-copy-light hover:bg-border hover:text-copy",
      )}
      disabled={disabled}
      onClick={(e) => {
        e.stopPropagation()
  ...
  if (active && payload && payload.length) {
    return (
      <div
        className={cx(
          // base
          "rounded-md border text-sm shadow-lg z-[9999]",
          // border color
          "border-border",
          // background color
          "bg-foreground",
      ...
      >
        <div className={cx("border-b border-border px-4 py-2")}>
          <p
            className={cx(
              // base
              "font-medium",
...
const AreaChart = React.forwardRef<HTMLDivElement, AreaChartProps>(
  (props, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cx("w-full h-full rounded-md flex", className)}
      ...
      >
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={cx("stroke-border stroke-1 opacity-30")}
                horizontal={true}
                vertical={false}
              />
            ) : null}
            <XAxis
              ...
              tick={{ transform: "translate(0, 6)", fill: "var(--color-copy-light)", fontSize: "0.75rem" }}
              ticks={
                startEndOnly
            ...
            >
              {xAxisLabel && (
                <Label
                  ...
                  offset={-20}
                  style={{ fill: "var(--color-copy)", fontSize: "0.875rem", fontWeight: "500" }}
                >
                  {xAxisLabel}
                </Label>
              )}
            ...
            <YAxis
              ...
              tick={{ transform: "translate(-3, 0)", fill: "var(--color-copy-light)", fontSize: "0.75rem" }}
              fill="var(--color-copy-light)"
              stroke=""
              className={cx(
                // base
            ...
            >
              {yAxisLabel && (
                <Label
                  position="insideLeft"
                  style={{ textAnchor: "middle", fill: "var(--color-copy)", fontSize: "0.875rem", fontWeight: "500" }}
                  angle={-90}
                  offset={-15}
                >
                  {yAxisLabel}
            ...
            <Tooltip
              ...
              content={({ active, payload, label }) => {
                ...
                if (
                  ...
                  tooltipCallback({ active, payload: cleanPayload, label: label?.toString() || "" })
                  prevActiveRef.current = active
                  prevLabelRef.current = label?.toString()
                }
